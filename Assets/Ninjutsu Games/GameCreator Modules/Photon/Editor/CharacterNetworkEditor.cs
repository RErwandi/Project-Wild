namespace NJG.PUN
{
    ...
    public class CharacterNetworkEditor : Editor
    {
        ...
        private void PaintCharacterBasicProperties()
        {
            ...
            EditorGUILayout.PropertyField(this.spLocomotion.FindPropertyRelative("syncPosition"));
            //EditorGUILayout.PropertyField(this.spLocomotion.FindPropertyRelative("syncDirection"));
            EditorGUI.indentLevel++;
            if (character.locomotion.syncPosition) EditorGUILayout.PropertyField(this.spTeleportDistance);
            EditorGUI.indentLevel--;
            ...
            EditorGUILayout.PropertyField(this.spLocomotion.FindPropertyRelative("syncCanRun"));
            EditorGUILayout.PropertyField(this.spLocomotion.FindPropertyRelative("syncRunSpeed"));
            EditorGUILayout.PropertyField(this.spLocomotion.FindPropertyRelative("syncCanJump"));
            EditorGUILayout.PropertyField(this.spLocomotion.FindPropertyRelative("syncJump"));
            EditorGUILayout.PropertyField(this.spLocomotion.FindPropertyRelative("syncGravity"));
            EditorGUILayout.PropertyField(this.spLocomotion.FindPropertyRelative("syncAngularSpeed"));
            EditorGUI.indentLevel--;
            EditorGUILayout.Space();
            ...
            EditorGUILayout.PropertyField(this.spSyncAttachments);
            EditorGUILayout.PropertyField(this.spCulling);

            if (this.spCulling.boolValue)
            {
